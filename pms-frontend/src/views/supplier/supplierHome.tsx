// pms-frontend/src/views/supplier/supplierHome.tsx
...
export default function supplierHome() {
  ...
  useEffect(() => {
    document.title = 'Trinity PMS — Supplier';
  }, []);
      ...
      <header className="w-full px-4 sm:px-6 lg:px-10 py-4 border-b dark:border-neutral-800">
        <div className="mx-auto max-w-7xl flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xl font-bold tracking-tight dark:text-white">Trinity PMS — Supplier</div>
