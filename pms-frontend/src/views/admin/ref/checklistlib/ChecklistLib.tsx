...
const cls = {
  thCell:
    "px-3 py-2 text-left text-[11px] font-semibold uppercase tracking-wide text-slate-600 border-b border-slate-200 dark:text-slate-200 dark:border-neutral-700",
  thBtn:
    "flex items-center gap-1 w-full text-left text-[11px] uppercase tracking-wide text-slate-600 hover:text-slate-900 focus:outline-none dark:text-slate-200",
  label:
