...
export default function ActivityEdit() {
  ...
  const [form, setForm] = useState<Partial<RefActivity> | null>(null);
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        if (!alive) return;
        // Ensure arrays exist to keep TagPickers controlled
        setForm({
          ...data,
          phase: Array.isArray(data?.phase) ? [...data.phase] : [],
          element: Array.isArray(data?.element) ? [...data.element] : [],
