...
export default function ConsultantsAssignments() {
  ...
  // Tile 3 — browse users (swap to role-specific BE when available)
  ...
  const onAssign = async () => {
    ...
    try {
      ...
      alert(`Assigned ${data?.created ?? items.length} consultant(s) to "${projectTitle}".`);
  ...
  return (
    <div className="mx-auto max-w-6xl">
          ...
          <div className="space-y-3" aria-label="Subtile: Validity">
            ...
            <div className="mt-2 flex items-center justify-end gap-2">
              ...
              <button
                ...
                onClick={onAssign}
                disabled={!canSubmit}
                title={canSubmit ? "Assign selected consultants to project" : "Select all required fields"}
              >
      ...
      <section className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border dark:border-neutral-800 p-4 mb-4" aria-label="Tile: Browse Consultants" data-tile-name="Browse Consultants">
        ...
        {/* Controls (same as other role pages) */}
        ...
        <div className="border rounded-xl dark:border-neutral-800 overflow-hidden">
          <div className="overflow-auto" style={{ maxHeight: "55vh" }}>
            ...
            {usersLoading ? (
              <div className="p-4 text-sm text-gray-600 dark:text-gray-300">Loading consultants…</div>
            ) : rowsPaged.length === 0 ? (
              <div className="p-4 text-sm text-gray-600 dark:text-gray-300">No consultants match the selected criteria.</div>
            ) : (
          ...
          <div className="flex items-center justify-between px-3 py-2 text-xs border-t dark:border-neutral-800">
            <div className="text-gray-600 dark:text-gray-300">
              Page <b>{pageSafe}</b> of <b>{totalPages}</b> · Showing <b>{rowsPaged.length}</b> of <b>{total}</b> consultants
