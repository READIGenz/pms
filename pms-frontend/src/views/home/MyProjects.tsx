      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-1.5 h-10 rounded-full border border-slate-200 bg-white px-4 text-xs sm:text-sm font-medium text-slate-700 shadow-sm
