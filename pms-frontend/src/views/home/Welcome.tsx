    ...
    <>
      <section className="relative overflow-hidden bg-white dark:bg-neutral-950 rounded-2xl shadow-sm border border-slate-200/80 dark:border-white/10 p-5 sm:p-6 lg:p-8">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 30% 30%, #e0cf13ff 0%, transparent 60%), radial-gradient(circle at 70% 70%, #a14f23ff 0%, transparent 60%), radial-gradient(circle at 50% 50%, #FCC020 0%, transparent 65%)",
          }}
        />
